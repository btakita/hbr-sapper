...
export function create_app({
	...
	const app_client_manifest = generate_app_client_manifest(manifest_data, path_to_routes);
	...
	write_if_changed(`${output}/internal/app-manifest-client.js`, app_client_manifest);
...
function generate_app_client_manifest(
	manifest_data: ManifestData,
...
function generate_client_manifest(
	...
	return `
		// This file is generated by Sapper — do not edit it!
		export const root_layout_path = '${stringify(get_file(path_to_routes, manifest_data.root), false)}';
		export const ErrorComponent_path = '${stringify(get_file(path_to_routes, manifest_data.error), false)}';
...
function generate_app(manifest_data: ManifestData, path_to_routes: string) {
	...
	return `
		...
		<script>
			...
			import { CONTEXT_KEY } from './shared.js';
